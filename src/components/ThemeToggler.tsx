...
const ThemeToggler = ({ variant = 'full' }: ThemeTogglerProps) => {
    ...
    if (variant === 'compact') {
        return (
            <button 
                ...
                className="theme-toggle-button p-2 rounded-full transition-transform duration-200 hover:scale-110"
    ...
    // Versión completa (original con switch)
    return (
